...
export class ProductDetailsComponent implements OnInit {
  ...
  async loadProduct() {
    this.product = await this.productsService.getProductt(this.id);
    // let premier = await this.productsService.getImage(this.product, 0);
    // this.imageToShow = await this.productsService.createImageFromBlob(premier);
    this.imageToShow = this.productsService.getPicture(this.product);
